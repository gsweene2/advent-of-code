...
from advent_of_code.y2022.d3 import (
    count_priorities,
    count_badge_priorities,
    _get_priority,
)
...
@patch("advent_of_code.y2022.d3._get_file_as_list")
def test_count_badge_priorities(mock__get_file_as_list):
    # Arrange
    input_list = [
        b"vJrwpWtwJgWrhcsFMMfFFhFp",
        b"jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL",
    ...
    # Act
    r = count_badge_priorities("https://some-fake-url.com/input")
